...
topics <- c("water")
corpus <- c("abstract.corpus", "policy.corpus") 
...
degree.nodes <- network_metrics[order(-degree)][1:10]
betweenness.nodes <- network_metrics[order(-betweenness)][1:10]
pagerank.nodes <- network_metrics[order(-closeness)][1:10]
...
```{r plot_network, dependson="add_features", fig.height=5, fig.width=5}
