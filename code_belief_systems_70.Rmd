...
```{r calculate_proportion, dependson="add_features"}
...
```{r plot_network, dependson="add_features", fig.height=6, fig.width=7}
...
```{r network_time, dependson="add_features"}
...
```{r plot_network_time, dependson="network_time"}
...
```{r plot_network_split_years, dependson="network_split_years", fig.height=6.5}
