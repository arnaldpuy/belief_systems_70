...
knitr::opts_chunk$set(echo = TRUE, dev = "tikz", cache = TRUE, message = FALSE)
```
...
```{r descriptive_plots, dependson="read_all_datasets", fig.height=2, fig.width=6.3, dev="pdf"}
...
```{r citations_support_claim, dependson="read_all_datasets", fig.height=1.4, fig.width=2.5, warning=FALSE, dev="pdf"}
...
```{r export_nodes_edges, dependson="add_features"}
...
```{r scale_free_plot, dependson=c("add_features", "read_all_datasets"), fig.height=1.6, fig.width=2.5, dev = "pdf"}
...
```{r merge_descriptive_plots, dependson=c("scale_free_plot", "citations_support_claim", "descriptive_plots"), fig.height=3.5, fig.width=5.7, dev = "pdf"}
...
```{r calculate_all_paths, dependson=c("add_features", "read_all_datasets")}
...
```{r results_count_paths, dependson="calculate_all_paths"}
...
## Citation paths ending in authorities

```{r citation_paths_authorities, dependson="add_features"}
...
```{r plot_network, dependson=c("add_features", "read_all_datasets"), fig.height=6, fig.width=7, dev = "pdf"}
...
```{r plot_evolution_nature.claim, dependson="add_features", dev = "pdf", fig.height=2.2, fig.width=5}
...
```{r plot_uncertainty_facts, dependson="add_features", fig.height=3.2, fig.width=4.7, dev="pdf"}
...
```{r plot_uncertainty_merged, dependson="plot_uncertainty_facts", fig.width=4, fig.height=5.5, dev = "pdf"}
...
```{r sum_no.claim_no.citation, dependson="proportion_paths"}
...
```{r plot_proportion_paths, dependson="proportion_paths", fig.height=2.4, fig.width=2.5, dev = "pdf"}
...
```{r plot_amplification, dependson="fun_amplification", fig.height=2, fig.width=3}
...
```{r plot_amplification_network, dependson="fun_amplification", dev = "pdf"}
...
```{r plot_ampl_merged, dependson="plot_amplification", fig.height=4.7, fig.width=3.1, dev = "pdf"}
...
```{r plot_merged_ind_ampl, dependson=c("plot_ampl_merged", "plot_amplification"), fig.width=3, fig.height=5.6, dev="pdf"}
...
```{r plot_merge_amp_modelling, dependson=c("plot_merged_ind_ampl", "plot_ampl_merged")}
...
```{r plot_amplification_uncertainty, dependson=c("plot_merged_ind_ampl", "plot_uncertainty_merged", "plot_proportion_paths", "plot_merge_amp_modelling"), fig.height=6, fig.width=6.2, dev = "pdf"}
...
```{r both_networks, dependson="network_metrics"}
...
```{r plot_network_complete, dependson="both_networks", dev = "pdf", fig.height=5.5, fig.width=5.5}
...
```{r plot_shared_networks, dependson="network_metrics", dev = "pdf", fig.height= 3.2, fig.width=4.5}
...
```{r aquastat_all_years, fig.height=2, fig.width=5, warning=FALSE, dev="pdf"}
...
```{r aquastat_merge_years, dependson="aquastat_all_years", fig.width=6.3, fig.height=3, warning=FALSE, dev="pdf"}
...
# Estimations compiled by Gleick 2000
...
```{r gww_unc, dependson=c("define_settings_unc", "functions_data")}
...
```{r industry_and_domestic, dependson=c("define_settings_unc", "functions_data")}
...
```{r industry_datasets, dependson=c("define_settings_unc", "functions_data")}
...
```{r domestic_values, dependson=c("define_settings_unc", "functions_data")}
...
```{r water.dt, dependson=c("domestic_values", "industry_datasets", "gww_unc")}
...
```{r water_unc, dependson="water.dt"}
...
```{r plot_unc_water, dependson="water_unc", dev="pdf"}
...
```{r sensitivity_water, dependson="water_unc"}
...
```{r merge_plots_water, dependson=c("sensitivity_water", "plot_unc_water"), dev="pdf"}
...
```{r plot_unc_food, dependson="food_unc", dev="pdf"}
...
```{r food_sens_analysis, dependson="food_unc", dev = "pdf"}
...
```{r merge.ua.sa.food, dependson=c("food_sens_analysis", "plot_unc_food"), dev="pdf"}
...
```{r merge.all.ua.sa, dependson=c("merge.ua.sa.food", "merge_plots_water"), dev="pdf", fig.height=3, fig.width=5.5}
...
```{r maize_calculations, dev = "pdf", fig.height=2, fig.width=5.5}
...
```{r kilocalories_wheat, echo = FALSE, dev="pdf"}
...
```{r kilocalories_wheat_plot, dependson="kilocalories_wheat", dev = "pdf", fig.height=2, fig.width=6}
...
```{r kilocalories_maize, echo=FALSE, dev="pdf"}
...
```{r kilocalories_maize_plot, dependson="kilocalories_maize", dev = "pdf", fig.height=2, fig.width=6}
